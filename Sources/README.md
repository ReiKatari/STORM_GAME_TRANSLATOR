...
[![Tech](https://img.shields.io/badge/Tech-Next.js+%2f+React+%2f+Electron+%2f+OCR-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_GAME_TRANSLATOR)
...
**STORM GAME TRANSLATOR** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
