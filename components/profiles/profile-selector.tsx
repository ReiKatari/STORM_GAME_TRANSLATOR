              ...
              >
                <div className="w-[140px] h-[140px] flex items-center justify-center">
                  <Image 
                    ...
                    width={140} 
                    height={140} 
                    className="w-[140px] h-[140px] object-contain drop-shadow-[0_0_20px_rgba(59,130,246,0.7)]"
                    priority
                  />
                </div>
                <h1 className="text-xl font-extrabold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-indigo-400 mt-2 font-mono uppercase drop-shadow-[0_2px_12px_rgba(59,130,246,0.6)]">
          ...
          {error && !selectedProfileId && (
            ...
            >
              <Alert variant="destructive" className="bg-red-500/10 border-red-500/20 text-red-200">
                ...
                <AlertDescription>
                  {error.includes('non trovato') || error.includes('not found') ? 'Профиль не найден' :
                   error.includes('password') || error.includes('non valida') ? 'Неверный пароль' :
                   error}
                </AlertDescription>
              </Alert>
            </motion.div>
