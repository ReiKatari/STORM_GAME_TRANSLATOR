...
const DEFAULT_PROVIDERS: AIProvider[] = [
  {
    id: 'translategemma',
    name: '⭐ TranslateGemma (Рекомендуется)',
    type: 'local',
  ...
  {
    id: 'aya-expanse',
    name: 'Aya Expanse (Визуальные новеллы/RPG)',
    type: 'local',
    baseUrl: 'http://localhost:11434',
  ...
  {
    id: 'command-r',
    name: 'Command R+ (Большой контекст)',
    type: 'local',
    baseUrl: 'http://localhost:11434',
