...
pub struct ProfileInfo {
    ...
    #[serde(alias = "isLocked", default)]
    pub is_locked: bool,
    /// Numero di tentativi di accesso falliti
    #[serde(alias = "failedAttempts", default)]
    pub failed_attempts: u32,
    /// Indica se il profilo ha credenziali salvate
    #[serde(alias = "hasCredentials", default)]
    pub has_credentials: bool,
    /// Versione dei settings
    #[serde(alias = "settingsVersion", default = "default_settings_version")]
...
pub struct ProfileSettings {
    ...
    pub language: String,
    /// Login automatico
    #[serde(alias = "autoLogin", default)]
    pub auto_login: bool,
    /// Impostazioni notifiche
    #[serde(default)]
    pub notifications: NotificationSettings,
    /// Impostazioni libreria giochi
    #[serde(alias = "gameLibrary", default)]
...
pub struct NotificationSettings {
    ...
    #[serde(alias = "desktopEnabled", default)]
    pub desktop_enabled: bool,
    /// Notifiche suoni abilitati
    #[serde(alias = "soundEnabled", default)]
    pub sound_enabled: bool,
    /// Notifiche per nuovi giochi
    #[serde(alias = "newGames", default)]
    pub new_games: bool,
